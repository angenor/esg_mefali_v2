...
const config = computed(() => buildBarConfig(props.series, theme.value, true))
const ariaLabel = computed(() => props.ariaLabel ?? props.title ?? 'Graphique en barres empilées')
