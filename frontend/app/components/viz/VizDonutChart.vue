<!-- F40 T029 — VizDonutChart : doughnut chart.js (cutout 60%). -->
...
const config = computed(() => buildPieConfig(props.series, theme.value, true))
const ariaLabel = computed(() => props.ariaLabel ?? props.title ?? 'Donut')
