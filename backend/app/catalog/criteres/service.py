...
TABLE = "critere"
JSONB_COLS = {"expression_json"}


def create(db: Session, payload: CritereCreate, *, actor_id: uuid.UUID) -> dict[str, Any]:
    body = payload.model_dump(mode="json")
    return insert_row(db, table=TABLE, body=body, actor_id=actor_id, jsonb_cols=JSONB_COLS)
